function createCalendar(e, t, a) {
      ...
      if ((0 > d ? (d += 12) : d > 11 && (d -= 12), 0 == l))
        ...
        (o.className += "cld-year"),
          5 > l
            ...
            : (o.innerHTML += e.Selected.Year + 1),
          n.appendChild(o);
      }
      n.appendChild(i);
    }
    a.appendChild(n),
      e.Options.NavLocation
  ...
  function l() {
    var a = document.createElement("div");
    if (
      ((a.className += "cld-datetime"),
      e.Options.NavShow && !e.Options.NavVertical)
    ) {
    ...
    if (
      ((l.className += " today"),
      (l.innerHTML = s[e.Selected.Month] + ", " + e.Selected.Year),
      a.appendChild(l),
      e.Options.NavShow && !e.Options.NavVertical)
    ) {
    ...
    e.Options.DatetimeLocation
      ? ((document.getElementById(e.Options.DatetimeLocation).innerHTML = ""),
        document.getElementById(e.Options.DatetimeLocation).appendChild(a))
      : r.appendChild(a);
  }
  function i() {
    ...
    for (var n = 0; n < e.Selected.Days; n++) {
      ...
      for (var o = t(n + 1), c = 0; c < e.Model.length; c++) {
        ...
        if (s.getTime() == p.getTime()) {
          ...
          if (
            ((h.className += "cld-title"),
            "function" == typeof e.Model[c].Link || e.Options.EventClick)
          ) {
            var v = document.createElement("a");
            if (
              (v.setAttribute("href", "#"),
              (v.innerHTML += e.Model[c].Title),
              ...
              v.addEventListener("click", e.Model[c].Link),
                e.Options.EventTargetWholeDay &&
                  ((l.className += " clickable"),
                  l.addEventListener("click", e.Model[c].Link));
            h.appendChild(v);
          } else
            h.innerHTML +=
  ...
  (r.className += "cld-main"),
    e.Options.Color &&
      (r.innerHTML +=
        "<style>.cld-main{color:" + e.Options.Color + ";}</style>"),
    e.Options.LinkColor &&
      (r.innerHTML +=
        "<style>.cld-title a{color:" + e.Options.LinkColor + ";}</style>"),
    t.appendChild(r),
